package	com.goslindarragh.PaperMoon.menu;
...
public	class MenuBuilder {
				...
				private	void	buildMenu()
				{
								...
								playHeading.add(	new	MenuItem(	
																...
																"com.goslindarragh.PaperMoon.playlist.PlaylistViewMenuItem"
																));
								playHeading.add(	new	MenuItem(	
																2,
																"List	Music",
																"List	the	music	available	in	the	system",
																"com.goslindarragh.PaperMoon.music.MusicViewMenuItem"
																));
								...
								playHeading.add(	new	MenuItem(	
																...
																"com.goslindarragh.PaperMoon.user.UserViewMenuItem"
																));	
								...
								maintainHeading.add(	new	MenuItem(	
																...
																"Add	User",
																"Add	a	user",
																"com.goslindarragh.PaperMoon.menu.UndefinedMenuItem"
																));	 	
